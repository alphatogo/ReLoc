...
if __name__ == "__main__":
    ...
    test_data = load_dataset(script_args.dataset_name, "test")
    train_data = load_dataset(script_args.dataset_name, "train")
    dataset = {}
    dataset['test'] = test_data["train"].select(range(min(20000,len(test_data["train"]))))
    dataset['train'] = train_data["train"]



    # dataset = load_dataset(script_args.dataset_name)
    # dataset['test'] = dataset["val"].select(range(min(10000,len(dataset["val"]))))
